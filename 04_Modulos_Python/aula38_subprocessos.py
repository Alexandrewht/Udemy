...
#  subprocess é um módulo Python para executar
...
#  - capture_output -> captura a saída e/ou erro para o uso posterior
...
#  - executável que iniciará o subprocesso.
...
#  Tente usar cp1252, cp852, cp850 (ou outros).
#  Linux e mac, use utf_8.
#  Comando de exemplo:
#  Windows: ping 127.0.0.1
#  Linux/Mac: ping 127.0.0.1 -c 4

# documentação de ping Windows
...
proc = subprocess.run(
    cmd, capture_output=True, # captura o stdout e o stderr
    text=True, encoding='cp850', # encoding para aparecer os caracteres com ascentos
)
