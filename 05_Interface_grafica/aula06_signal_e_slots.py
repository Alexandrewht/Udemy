...
# -> slot (função que vai ser executada quando o botão for clicado)
# -> signal (sinal que vai ser executado quando o botão for clicado)
...
# Hovered não funciona bem com ações verificáveis, precisamos encontrar outra maneira, se necessário
