...
class MyWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.primeira_acao.triggered.connect(self.muda_msg_da_status_bar)
        ...
        self.segunda_action.hovered.connect(self.muda_msg_da_status_bar)

    @Slot()
    def muda_msg_da_status_bar(self):
